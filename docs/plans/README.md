...
### design
- [Navegação multi-projeto](design/navegacao-multi-projeto.md) — quadro unificado por projetos (chips + grupos sticky + "◆ Sua vez") e abas de trabalho persistentes no editor; mockups lo-fi (3 direções) e protótipo hi-fi navegável em `mockups/navegacao-multi-projeto/`. **Status: Em andamento** — PR [#11](https://github.com/marlonwlv/inhouse/pull/11), revisado em 2026-08-18 (2026-08-14).
