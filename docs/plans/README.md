...
- [Inhouse instalável no Mac — app de menu bar](features/app-mac-menu-bar.md) — DMG com launcher ObjC + servidor tsc + runtime Node embutido (npm incluso); reusa um Inhouse já aberto; `npm run build:mac`. **Status: Em andamento** (2026-08-13).
